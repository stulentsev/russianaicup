...
CONFIG_FILE=/home/sergio/raic/localrunner-configs/tcp-vs-tcp.json
...
./bin/aicup2020-v11 127.0.0.1 31002 token "$@" >/dev/null 2>&1 &
./bin/aicup2020-v11 127.0.0.1 31003 token "$@" >/dev/null 2>&1 &
